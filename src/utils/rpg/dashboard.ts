...
export function renderDashboard(player: PlayerInventory, userName: string) {
  ...
  const row2 = new ActionRowBuilder<ButtonBuilder>().addComponents(
    new ButtonBuilder().setCustomId('town_generals').setLabel('Jenderal').setEmoji('🎖️').setStyle(ButtonStyle.Success),
    new ButtonBuilder().setCustomId('town_army').setLabel('Pasukan').setEmoji('🥷').setStyle(ButtonStyle.Primary),
    new ButtonBuilder().setCustomId('town_siege_menu').setLabel('Serang Kota').setEmoji('⚔️').setStyle(ButtonStyle.Danger),
    new ButtonBuilder().setCustomId('town_deploy_dungeon').setLabel('Dungeon').setEmoji('🏰').setStyle(ButtonStyle.Danger),
    new ButtonBuilder().setCustomId('town_deploy_boss').setLabel('World Boss').setEmoji('👹').setStyle(ButtonStyle.Danger)
  );
